...
1. `README.md` — GitHub/root entry page
2. `docs/INDEX.md` — Documentation table of contents
3. `PROJECT_OVERVIEW.md` — This file (quick app summary)
4. `docs/TECHNICAL_OVERVIEW.md` — Deep technical reference
5. Topic-specific files inside `docs/`
